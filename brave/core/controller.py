...
class AuthorizeHandler(HTTPMethod):
    ...
    def get(self, ar=None):
        ...
        ngrant = ApplicationGrant(user=u, application=ar.application, _mask=grant._mask, expires=expiration, chars=grant.characters, all_user_chars=grant.all_user_chars)
        ngrant.save()
